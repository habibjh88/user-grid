...
?>
	<style>
		.gtusers-help-wrapper {
			width: 60%;
			margin: 0 auto;
		}
		.gtusers-help-section iframe {
			max-width: 100%;
		}
		.gtusers-help-wrapper .rt-document-box .rt-box-title {
			margin-bottom: 30px;
		}
		.gtusers-help-wrapper .gtusers-help-section {
			margin-top: 30px;
		}
		.gtusers-feature-list ul {
			display: flex;
			flex-wrap: wrap;
		}
		.gtusers-feature-list ul li {
			margin: 5px 10px 5px 0;
			width: calc(50% - 20px);
			flex: 0 0 calc(50% - 20px);
			font-size: 14px;
		}
		.gtusers-feature-list ul li i {
			color: var(--rt-primary-color);
		}
		.gtusers-pro-feature-content {
			display: flex;
			flex-wrap: wrap;
		}
		.gtusers-pro-feature-content .rt-document-box + .rt-document-box {
			margin-left: 30px;
		}
		.gtusers-pro-feature-content .rt-document-box {
			flex: 0 0 calc(33.3333% - 60px);
			margin-top: 30px;
		}
		.gtusers-testimonials {
			display: flex;
			flex-wrap: wrap;
		}
		.gtusers-testimonials .gtusers-testimonial + .gtusers-testimonial  {
			margin-left: 30px;
		}
		.gtusers-testimonials .gtusers-testimonial  {
			flex: 0 0 calc(50% - 30px)
		}
		.gtusers-testimonial .client-info {
			display: flex;
			flex-wrap: wrap;
			font-size: 14px;
			align-items: center;
		}
		.gtusers-testimonial .client-info img {
			width: 60px;
			height: 60px;
			object-fit: cover;
			border-radius: 50%;
		...
		.gtusers-testimonial .client-info .gtusers-star {
			color: var(--rt-primary-color);
		}
		.gtusers-testimonial .client-info .client-name {
			display: block;
			color: #000;
			font-size: 16px;
			font-weight: 600;
		...
		.gtusers-call-to-action:hover a {
		...
		@media all and (max-width: 991px) {
			...
			.gtusers-pro-feature-content .rt-document-box + .rt-document-box + .rt-document-box {
				margin-left: 0;
			}
		}
	...
	<div class="gtusers-help-wrapper" >
		<div class="gtusers-help-section rt-document-box">
		...
		<div class="rt-document-box">
			...
			<div class="rt-box-content gtusers-feature-list">
		...
		<div class="gtusers-call-to-action" style="background-image: url('<?php echo gtUsers()->get_assets_uri( 'images/admin/banner.png' ); ?>')">
		...
		<div class="rt-document-box">
			...
			<div class="rt-box-content">
				...
				<div class="gtusers-testimonials">
					<div class="gtusers-testimonial">
						...
						<div class="client-info">
							<img src="<?php echo esc_url(gtUsers()->get_assets_uri( 'images/admin/client1.jpeg' ) ); ?>">
							<div>
								<div class="gtusers-star">
					...
					<div class="gtusers-testimonial">
						...
						<div class="client-info">
							<img src="<?php echo esc_url( gtUsers()->get_assets_uri( 'images/admin/client2.jpeg' ) ); ?>">
							<div>
								<div class="gtusers-star">
									<i class="dashicons dashicons-star-filled"></i>
									<i class="dashicons dashicons-star-filled"></i>
		...
		<div class="gtusers-pro-feature-content">
			<div class="rt-document-box">
				<div class="rt-box-icon"><i class="dashicons dashicons-media-document"></i></div>
				<div class="rt-box-content">
