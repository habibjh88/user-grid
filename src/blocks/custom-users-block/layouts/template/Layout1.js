        ...
        <div key={user.id} className={`user-item-col ${user_column}`}>
            <div className="user-inner-wrapper">
                ...
                <div className="user-content-wrap clearfix">
                    ...
                    {bio_visibility && <>
                        <a className="load-user-button" variant="secondary" onClick={openModal}>
