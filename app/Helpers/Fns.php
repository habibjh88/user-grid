...
class Fns {
	...
	public static function get_user_social_icon( $user_id, $data ) {
		$facebook  = get_user_meta( $user_id, 'gt_users_facebook', true );
		$twitter   = get_user_meta( $user_id, 'gt_users_twitter', true );
		$linkedin  = get_user_meta( $user_id, 'gt_users_linkedin', true );
		$gplus     = get_user_meta( $user_id, 'gt_users_gplus', true );
		$pinterest = get_user_meta( $user_id, 'gt_users_pinterest', true );
